...
new_html = new_html.replace('<!-- ===================== CINEMATIC BANNER ===================== -->', '<!-- ===================== FUN TO KNOW BY NUMBERS ===================== -->')
...
# Replace the specific lines inside about.html
...
about_html = re.sub(content_placeholder, new_about_content, about_html, flags=re.DOTALL)
